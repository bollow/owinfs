#!/usr/bin/php
<?php
$html_title="Development Agenda / Special and Differential Treatment (SDT)";
include 'include/head_etc.php'
?>
    <div id="main" class="group">
<?php
$this_theme="Development Agenda / SDT";
...
?>
      ...
      <div id="content" class="singlecolumn">
        ...
        <div id="content-header">
          <h1 class="title">Development Agenda / Special and Differential Treatment (SDT)</h1>
        </div> <!-- /#content-header -->
...
<ul class="tail">
  <li>allowing more flexibilities in trade-related investment measures (TRIMs) so that developing countries could foment industrial policies (such as targeted subsidies and local content requirements);
  <li>allowing Least Developed Countries (LDCs) flexibility from TRIPS and TRIMS rules as long as they are LDCs; 
  <li>ensuring that Duty Free Quota Free (DFQF) applies to 100 percent of exports by LDCs; 
  <li>not forcing additional commitments from LDCs in their processes of acceding to the WTO; 
  <li>ensuring that food security is paramount in guiding ongoing and future trade negotiations;
  <li>removing limitations on the movement of persons and facilitating process of recognition of qualifications in services rules; 
  <li>allowing more tools to combat trade mispricing which allows for tax fraud by TNCs; and many more. 
</ul>
<p>
...
<ul class="tail">
  <li>trying to force developing countries to negotiate flexibilities on a case-by-case basis, abolishing the solidarity and benefits of collective bargaining to developing countries; 
  <li>creating onerous new requirements on transparency and notification; 
  <li>imposing new restrictions on companies they deem as state-trading enterprises; and 
...
<div class="noindex">Various WTO Members submitted a Communication to the WTO in November 2018 which, if accepted, would affect the implementation of Members’ transparency and notification obligations at the WTO. It would strengthen the already burdensome notification obligations and introduce new punitive administrative measures should obligations not be complied with. This paper provides information about WTO Members’ current notification obligations and their level of compliance; looks at the history of discussions on notifications, particularly in the Working Group on Notification Obligations and Procedures which took place in 1995 – 1996; and provides an analysis of the Communication.</div>
<p>
