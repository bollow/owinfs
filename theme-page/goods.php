#!/usr/bin/php
<?php
$html_title="Trade in Goods";
include 'include/head_etc.php'
?>
    <div id="main" class="group">
<?php
$this_theme="Trade in Goods";
...
?>
      ...
      <div id="content" class="singlecolumn">
        ...
        <div id="content-header">
          <h1 class="title">Trade in Goods</h1>
        </div> <!-- /#content-header -->
