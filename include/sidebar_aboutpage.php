...
?>
        ...
        <div class="content">
        <p>Notre monde n'est pas à vendre (OWINFS) est un réseau mondial d'organismes et de mouvements sociaux qui s'opposent aux ententes commerciales et aux accords d'investissement qui favorisent les intérêts des sociétés les plus puissantes du monde au détriment des personnes et de l'environnement.</p>
...
?>
        ...
        <div class="content">
        <p>Our World Is Not For Sale (OWINFS) è una rete globale di organizzazioni e movimenti sociali impegnati a sfidare gli accordi commerciali e sugli investimenti che favoriscono gli interessi delle più potenti imprese multinazionali, a danno delle popolazioni e dell’ambiente.</p>
