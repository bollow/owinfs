#!/usr/bin/php
<?php
$html_title="Digital Trade Rules: A disastrous new constitution for the global economy written by and for Big Tech";
...
?>
      ...
      <div id="content" class="singlecolumn">
        ...
        <div id="content-header">
          <h1 class="title">Digital Trade Rules</h1>
	  <img src="/2020/Digital_trade_rules.png" width="200" align="left" style="padding: 0 20px 10px 0">
          <h2 class="title">A disastrous new constitution for the global economy written by and for Big Tech</h1>
        </div> <!-- /#content-header -->
...
<h3>Emerging challenges in 2020</h3>
	<p>
The WTO itself is in serious crisis. The 12th WTO Ministerial Conference was due to be held in June 2020, but has been postponed – possibly for another year. WTO Director-General Roberto Azevêdo has said he will step down on 31 August 2020, a year before the completion of his term of office. The United States is still blocking the appointment of new Appellate Body Members to the WTO, which means the judicial function is not operational.
	<p>
At the same time, many countries have had to take measures to deal with the coronavirus that are inconsistent with their WTO obligations. This is leading to a re-thinking of whether the WTO model – which left many countries short on domestic productive capacity and locked in rules that put foreign corporate rights over the domestic public health emergency – are really fit for purpose. Thus, there is a need for countries to have greater flexibility to depart from existing trade rules. This could well lead to a fundamental re-think of the WTO and its model of extreme liberalisation – an urgent and welcome outcome.
	<p>
...
To accomplish this, however, we need to ensure that corporations are unable to acquire new WTO ‘trade’ disciplines designed by Big Tech to consolidate their power over our economy and to limit democratic oversight in the public interest.
	<p>
<a href="/2020/Digital_trade_rules.pdf"><u>Download</u>: Read the full text</a> (pdf)
        </div> <!-- /#content-area -->
      </div> <!-- /#content -->
    </div> <!-- /#main -->
<?php
