#!/usr/bin/php
<?php
$html_title="12th WTO Ministerial, Geneva 2021";
...
?>
      <div id="content" class="singlecolumn">
        <div id="content-header">
          <h1 class="title">12<sup>th</sup> Ministerial, Geneva 2021</h1>
        </div> <!-- /#content-header -->
...
<a href="#digital">digital trade</a> (so-called e-commerce).
They are attempting to legitimize these illegal “Joint Statement Initiative” (JSI) plurilateral negotiations to make the WTO even more corporate-driven.
 <p>
Developed countries are also pursuing an agreement to discipline <a href="#fish">fisheries subsidies</a>, but without the mandate on development.
 <p>
Instead, negotiators should focus on transforming the existing rules to allow countries to pursue development and shared prosperity, in areas such as <a href="#agriculture">agriculture</a> and the <a href="#SDT">development agenda</a>.
 <p>
