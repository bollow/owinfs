#!/usr/bin/php
<?php
$html_title="Digital trade rules and Big Tech: Surrendering public good to private power";
...
?>
      ...
      <div id="content" class="singlecolumn">
        ...
        <div id="content-area">
	<p>
<b>As tech giants emerge as the undisputed winners of the Covid-19 crisis, they continue to use free trade agreements to protect themselves from regulation. A new report from PSI raise the alarm about the damaging implications this would have for the democratic and just societies we aspire to.</b>
<p>
...
<p>
Online services have exploded and the major tech companies are seeing a surging demand. According to reports, the shares of major tech companies have outperformed the market since late January.
<p>
At a time when we need governments to protect our interests more than ever, Big Tech companies are using free trade agreements to protect themselves from regulation.
<p>
...
<p>
    Tech giants are bad employers and bad citizens and unchecked powers are a risk to democratic and just societies we aspire to
<p>
...
<p>
<a href="2020/PSI_Surrendering.pdf"><u>Download</u>: Read the report</a> (pdf)
        </div> <!-- /#content-area -->
      </div> <!-- /#content -->
    </div> <!-- /#main -->
<?php
